 <?php
    ...
    */
    ...
    'vehicle_verification' => [
        ...
        'sim_file' => [
            'required' => 'SIM file is required.',
            'file' => 'SIM must be a valid file.',
            'mimes' => 'SIM must be a file of type: :values.',
            'max' => 'SIM may not be greater than :max kilobytes.',
        ],
        'sim_meta' => [
            'required' => 'SIM metadata is required.',
            'array' => 'SIM metadata must be an array.',
            'number' => [
                'required' => 'SIM number is required.',
            ],
        ],
        'sim_expiry_date' => [
            'required' => 'SIM expiry date is required.',
            'date' => 'SIM expiry date must be a valid date.',
            'after' => 'SIM expiry date must be after today.',
        ],
        'stnk_file' => [
            'required' => 'STNK file is required.',
            'file' => 'STNK must be a valid file.',
            'mimes' => 'STNK must be a file of type: :values.',
            'max' => 'STNK may not be greater than :max kilobytes.',
        ],
        'stnk_expiry_date' => [
            'required' => 'STNK expiry date is required.',
            'date' => 'STNK expiry date must be a valid date.',
            'after' => 'STNK expiry date must be after today.',
        ],
        'vehicle_photos' => [
            'required' => 'Vehicle photos are required.',
            'array' => 'Vehicle photos must be an array.',
            'min' => 'At least :min vehicle photos are required.',
            'max' => 'No more than :max vehicle photos are allowed.',
            'file' => 'Each vehicle photo must be a valid file.',
            'mimes' => 'Each vehicle photo must be a file of type: :values.',
            'max' => 'Each vehicle photo may not be greater than :max kilobytes.',
        ]
    ],
    ...
    'status' => [
        ...
        'active_services' => [
            'required' => 'Active services is required.',
            'array' => 'Active services must be an array.',
            'min' => 'At least one active service must be selected.',
            'max' => 'Maximum :max active services allowed.',
        ],
        'active_service' => [
