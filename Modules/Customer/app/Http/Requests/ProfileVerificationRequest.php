...
class ProfileVerificationRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'selfie_with_id_card_file.required' => __('customer::validation.profile_verification.selfie_with_id_card_file.required'),
            'selfie_with_id_card_file.file' => __('customer::validation.profile_verification.selfie_with_id_card_file.file'),
            'selfie_with_id_card_file.mimes' => __('customer::validation.profile_verification.selfie_with_id_card_file.mimes'),
            'selfie_with_id_card_file.max' => __('customer::validation.profile_verification.selfie_with_id_card_file.max'),

            'selfie_with_id_card_meta.array' => __('customer::validation.profile_verification.selfie_with_id_card_meta.array'),
        ];
    }
