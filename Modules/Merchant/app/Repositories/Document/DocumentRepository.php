...
namespace Modules\Merchant\Repositories\Document;
...
class DocumentRepository implements IDocumentRepository
{
    ...
    {
        $cacheKey = $this->cacheKeyManager::getDocumentsByDocumentableKey($profileId, \Modules\Merchant\Models\Profile::class);
    ...
    {
        $cacheKey = $this->cacheKeyManager::getDocumentByIdKey($id);
