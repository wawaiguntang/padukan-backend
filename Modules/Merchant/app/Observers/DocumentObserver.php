...
class DocumentObserver
{
    ...
    protected function invalidateDocumentableCaches(string $documentableId, string $documentableType): void
    {
        ...
        if ($documentableType === 'Modules\Merchant\Models\Profile') {
            $this->cache->forget($this->keyManager::getDocumentsByDocumentableKey($documentableId, $documentableType));
        }
    }
    ...
    {
        $this->cache->forget($this->keyManager::getDocumentByIdKey($documentId));
    }
